...
$router->group(['prefix' => 'api'], function ($router) {
    ...
    $router->put('/ciclos','CicloController@update');
    ...
    $router->put('/alumnes','AlumneController@update');
    ...
    $router->put('/empresas','EmpresaController@update');
    ...
    $router->put('/ofertas','OfertaController@update');
